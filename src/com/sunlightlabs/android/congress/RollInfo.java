...
public class RollInfo extends ListActivity implements LoadPhotoTask.LoadsPhoto {
	...
	public void onLoadRoll(String tag, CongressException exception) {
		...
		if (tag.equals("basic")) {
			...
			((TextView) loadingView.findViewById(R.id.loading_message)).setText(R.string.error_loading_votes);
		}
	}
	...
	public void displayRoll() {
		...
		((TextView) resultHeader.findViewById(R.id.header_text)).setText(R.string.results);
		...
		((TextView) loadingView.findViewById(R.id.loading_message)).setText(R.string.loading_votes);
	...
	private static class VoterAdapter extends ArrayAdapter<Roll.Vote> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			case Roll.NOT_VOTING:
				voteView.setText(R.string.not_voting);
				voteView.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
